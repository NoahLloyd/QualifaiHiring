    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg border border-gray-100 shadow-sm">
          <div className="p-5">
            <div className="flex items-center justify-between">
              <h3 className="text-gray-800 font-medium">Applicants to Review</h3>
            ...
            <div className="mt-3">
              ...
              <div className="text-sm text-gray-500 mt-1">to stay on track</div>
            </div>
          </div>
          <div className="border-t border-gray-100 py-2 px-5 text-right">
            <Button 
              variant="ghost" 
              className="text-gray-700 hover:text-gray-900 p-0 h-auto text-sm font-medium"
        ...
        <div className="bg-white rounded-lg border border-gray-100 shadow-sm">
          <div className="p-5">
            <div className="flex items-center justify-between">
              <h3 className="text-gray-800 font-medium">Today's Meetings</h3>
            ...
            <div className="mt-3">
              ...
              <div className="text-sm text-gray-500 mt-1">scheduled interviews</div>
            </div>
          </div>
          <div className="border-t border-gray-100 py-2 px-5 text-right">
            <Button 
        ...
        <div className="bg-white rounded-lg border border-gray-100 shadow-sm">
          <div className="p-5">
            <div className="flex items-center justify-between">
              <h3 className="text-gray-800 font-medium">Follow-ups</h3>
            ...
            <div className="mt-3">
              ...
              <div className="text-sm text-gray-500 mt-1">pending responses</div>
            </div>
          </div>
          <div className="border-t border-gray-100 py-2 px-5 text-right">
            <Button 
